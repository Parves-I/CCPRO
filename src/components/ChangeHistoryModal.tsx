...
import { History, Globe, RotateCcw, Loader2 } from 'lucide-react';
...
export function ChangeHistoryModal({ isOpen, onClose }: ChangeHistoryModalProps) {
    const { activeAccount, activeProject, restoreVersion, loading: projectLoading } = useProject();
    ...
    const handleRestore = async () => {
        ...
        await restoreVersion(restoringLog.snapshot);
    ...
    return (
        <>
            <Dialog open={isOpen} onOpenChange={onClose}>
                <DialogContent className="max-w-3xl h-[75vh] flex flex-col">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Last 50 saves. You can restore your project to any of these versions.
                        </DialogDescription>
                    </DialogHeader>
            ...
            <AlertDialog open={!!restoringLog} onOpenChange={(open) => !open && setRestoringLog(null)}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                    ...
                    <AlertDialogFooter>
                        ...
                        <AlertDialogAction onClick={handleRestore} disabled={projectLoading}>
                            {projectLoading && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
                            Restore Version
                        </AlertDialogAction>
                    </AlertDialogFooter>
                </AlertDialogContent>
